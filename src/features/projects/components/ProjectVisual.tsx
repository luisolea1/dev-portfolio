...
export function ProjectVisual({ project }: { project: Project }) {
  return (
    <div className={`project-visual project-visual--${project.visual}`}>
      {project.image ? (
        <img className="project-visual__image" src={project.image} alt={project.imageAlt ?? ''} width={project.imageWidth} height={project.imageHeight} style={{ objectPosition: project.imagePosition }} loading="lazy" />
      ) : (
