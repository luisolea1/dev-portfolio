    ...
    <article className="project-detail container">
      ...
      <div className="project-detail__body">
        ...
        <section className="project-detail__section" aria-labelledby="project-contributions">
          <h2 id="project-contributions" className="project-detail__section-title">Mi contribución</h2>
          {project.contributions.length ? <ul className="project-detail__contributions">{project.contributions.map((contribution) => <li key={contribution}>{contribution}</li>)}</ul> : <p className="project-detail__text">[RESPONSABILIDADES, DECISIONES Y APORTACIONES REALES]</p>}
        </section>
